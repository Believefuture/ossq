...
function updateclick(msg,recname,recaddress,postcode,tel){
    ss.colorbox({
        html :
            ...
            "<tr>"+
            "<td style='margin: 0'>"+
            "<form id='formid' action='/chart1/update' method='post'>"+
...
function deletemeradd(msg){
    ss.ajax({
        type : "POST",
        url : "/chart1/deletemeradd",
        data : {id : msg},
        dataType : "Text",
        success : function(msg){
            alert(msg);
            window.location = _path+"/chart1/chart01"
        },
        error : function(msg){
            alert(msg)
        }
...
function meradd(){
    ...
    ss.ajax({
        type : "POST",
        url : _path+"/chart1/meraddsession",
